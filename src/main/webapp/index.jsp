	    ...
	    <dl id="menu-product">
			...
			<dd>
				<ul>
					...
					<li><a data-href="product/product-list" data-title="商品添加" href="javascript:void(0)">商品添加</a></li>
					<li><a data-href="product/product-llist" data-title="商品管理" href="javascript:void(0)">商品管理</a></li>
			</ul>
		</dd>
	</dl>
		<dl id="menu-article">
