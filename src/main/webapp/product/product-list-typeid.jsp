...
<div class="page-container">
	<div class="page-container">
		<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a><a class="btn btn-primary radius" onclick="product_add('添加产品','product-add?id=${requestScope.list1}')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加产品</a></span>
		...
		<div class="mt-20">
			<table class="table table-border table-bordered table-bg table-hover table-sort" style="table-layout: fixed;">
				...
				<c:forEach items="${requestScope.list}" var="r">
					<tr class="text-c va-m" style="height: 90px;">
						...
						<c:if test="${r.status==0 }">
						   ...
						   <td class="td-manage">
						        ...
						        <a style="text-decoration:none;display: none;" id="on${r.id}" onClick="product_start(this,${r.id})" href="javascript:;" title="发布"><i class="Hui-iconfont">&#xe603;</i></a> 
						         <a style="text-decoration:none" class="ml-5" onClick="product_edit('商品编辑','product-edit?id=${r.id}')" href="javascript:;" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a> 
