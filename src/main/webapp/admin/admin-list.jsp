	...
	<table class="table table-border table-bordered table-bg table-hover table-sort">
		...
		<tbody>
				...
				<td class="td-manage"><a style="text-decoration:none;" id="off${r.id}"  onClick="admin_stop(this,${r.id})" href="javascript:;" title="开除"><i class="Hui-iconfont">&#xe631;</i></a>
				                      ...
				                      <a title="编辑" href="javascript:;" onclick="admin_edit('管理员编辑','edit?id=${r.id}','1','800','460')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>
				                      <a onClick="admin_orepass(${r.id})" href="javascript:;" title="密码重置" style="text-decoration:none;margin-left: 10px;"><i class="fa fa-repeat" aria-hidden="true"></i></a>
				                      </td>
				</c:if>
